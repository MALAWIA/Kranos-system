      ...
      <section className="bg-gradient-to-br from-blue-600 to-blue-800 py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="mb-6 text-4xl md:text-5xl">About Kranos</h1>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mb-4 text-lg text-gray-700">
                Kranos is a Kenyan-based automation agency specializing in helping small and medium enterprises transform their operations through intelligent automation.
              </p>
              <p className="mb-4 text-lg text-gray-700">
